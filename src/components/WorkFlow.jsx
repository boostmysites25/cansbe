...
import { serviceWorkflow } from "../data/constant";
      ...
      >
        ...
        <div className="z-10 grid grid-cols-1 mt-4 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-10 mx-auto max-w-6xl">
          {serviceWorkflow.map((item) => (
            <div key={item.id} className="relative flex flex-col gap-2 items-start bg-primary/5 hover:bg-primary/10 rounded-lg p-5 hover:scale-105 transition-all duration-300">

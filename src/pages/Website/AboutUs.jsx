    ...
    <div className="landing-bg">
        ...
        <div className="grid lg:grid-cols-2 lg:items-start gap-10">
          <div>
            ...
            <p className="mt-6">
              ...
              technology that drives growth and efficiency. Let us be the
              partner that helps your business thrive in a constantly evolving
              digital landscape.
            </p>
          </div>
      ...
      <section className="wrapper text-center">
        ...
        <p>
          ...
          with cutting-edge technologies, we’re here to make it happen. Choose
          us, and you’ll get a partner who truly understands your needs and
          works relentlessly to help your business thrive
        </p>
      </section>
      <SolveITNeeds />
      <Footer />
